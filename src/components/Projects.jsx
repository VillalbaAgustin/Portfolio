...
const slides = [
   {
      ...
      href: "https://calendar-backend-production-9efe.up.railway.app/",
         ...
         <div id="" className="card__container ">
            <div className="projects__container">
               ...
               <div className="dot__container">
                  <a className="href__git" target="_blank" href={slides[currentIndex].hrefGit}>
                  ...
                  <a className="href__page" target="_blank" href={slides[currentIndex].href}>
